...
class ProofsModule extends _TonSdkModule {
  ...
  Future<void> proof_block_data(ParamsOfProofBlockData params) async {
    await _tonCore.request('proofs.proof_block_data', params.toString(), null);
  }
  ...
  Future<void> proof_transaction_data(
    ...
    await _tonCore.request(
        'proofs.proof_transaction_data', params.toString(), null);
  }
  ...
  Future<void> proof_message_data(ParamsOfProofMessageData params) async {
    await _tonCore.request(
        'proofs.proof_message_data', params.toString(), null);
  }
}
