...
class UtilsModule extends _TonSdkModule {
  ...
  Future<ResultOfConvertAddress> convert_address(
    ...
    final res = await _tonCore.request(
        'utils.convert_address', params.toString(), null);
  ...
  Future<ResultOfGetAddressType> get_address_type(
    ...
    final res = await _tonCore.request(
        'utils.get_address_type', params.toString(), null);
  ...
  Future<ResultOfCalcStorageFee> calc_storage_fee(
    ...
    final res = await _tonCore.request(
        'utils.calc_storage_fee', params.toString(), null);
  ...
  Future<ResultOfCompressZstd> compress_zstd(
    ...
    final res =
        await _tonCore.request('utils.compress_zstd', params.toString(), null);
  ...
  Future<ResultOfDecompressZstd> decompress_zstd(
    ...
    final res = await _tonCore.request(
        'utils.decompress_zstd', params.toString(), null);
