...
class ProcessingEvent_WillFetchFirstBlock extends ProcessingEvent {
  ...
  ProcessingEvent_WillFetchFirstBlock({
    ...
    required String message_dst,
  }) {
    _type = 'WillFetchFirstBlock';
    _message_id = ArgumentError.checkNotNull(
        message_id, 'ProcessingEvent_WillFetchFirstBlock message_id');
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_WillFetchFirstBlock message_dst');
  }
  ProcessingEvent_WillFetchFirstBlock.fromMap(Map<String, dynamic> map) {
    ...
    if (map.containsKey('message_dst') && (map['message_dst'] != null)) {
      _message_dst = map['message_dst'];
    } else {
      throw ('Wrong map data');
    }
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    if (_message_dst != null) {
      map['message_dst'] = _message_dst;
    }
    map['type'] = _type;
    return map;
  }
...
class ProcessingEvent_FetchFirstBlockFailed extends ProcessingEvent {
  ...
  ProcessingEvent_FetchFirstBlockFailed({
    ...
    _message_id = ArgumentError.checkNotNull(
        message_id, 'ProcessingEvent_FetchFirstBlockFailed message_id');
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_FetchFirstBlockFailed message_dst');
  }
...
class ProcessingEvent_WillSend extends ProcessingEvent {
  ...
  ProcessingEvent_WillSend({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_WillSend message_dst');
    _message =
...
class ProcessingEvent_DidSend extends ProcessingEvent {
  ...
  ProcessingEvent_DidSend({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_DidSend message_dst');
    _message =
...
class ProcessingEvent_SendFailed extends ProcessingEvent {
  ...
  ProcessingEvent_SendFailed({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_SendFailed message_dst');
...
class ProcessingEvent_WillFetchNextBlock extends ProcessingEvent {
  ...
  ProcessingEvent_WillFetchNextBlock({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_WillFetchNextBlock message_dst');
    _message = ArgumentError.checkNotNull(
...
class ProcessingEvent_FetchNextBlockFailed extends ProcessingEvent {
  ...
  ProcessingEvent_FetchNextBlockFailed({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_FetchNextBlockFailed message_dst');
    _message = ArgumentError.checkNotNull(
...
class ProcessingEvent_MessageExpired extends ProcessingEvent {
  ...
  ProcessingEvent_MessageExpired({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_MessageExpired message_dst');
    _message = ArgumentError.checkNotNull(
...
class ProcessingEvent_RempSentToValidators extends ProcessingEvent {
  ...
  ProcessingEvent_RempSentToValidators({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_RempSentToValidators message_dst');
...
class ProcessingEvent_RempIncludedIntoBlock extends ProcessingEvent {
  ...
  ProcessingEvent_RempIncludedIntoBlock({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_RempIncludedIntoBlock message_dst');
    _timestamp = ArgumentError.checkNotNull(
...
class ProcessingEvent_RempIncludedIntoAcceptedBlock extends ProcessingEvent {
  ...
  ProcessingEvent_RempIncludedIntoAcceptedBlock({
    ...
    _message_dst = ArgumentError.checkNotNull(message_dst,
        'ProcessingEvent_RempIncludedIntoAcceptedBlock message_dst');
    _timestamp = ArgumentError.checkNotNull(
...
class ProcessingEvent_RempOther extends ProcessingEvent {
  ...
  ProcessingEvent_RempOther({
    ...
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_RempOther message_dst');
    _timestamp = ArgumentError.checkNotNull(
...
class ProcessingEvent_RempError extends ProcessingEvent {
  ...
  ProcessingEvent_RempError({
    ...
    _type = 'RempError';
    _message_id = ArgumentError.checkNotNull(
        message_id, 'ProcessingEvent_RempError message_id');
    _message_dst = ArgumentError.checkNotNull(
        message_dst, 'ProcessingEvent_RempError message_dst');
    _error =
...
class MessageMonitoringTransactionCompute extends TonSdkStructure {
  ...
  MessageMonitoringTransactionCompute({
    ...
    _exit_code = ArgumentError.checkNotNull(
        exit_code, 'MessageMonitoringTransactionCompute exit_code');
  }
  MessageMonitoringTransactionCompute.fromMap(Map<String, dynamic> map) {
...
class MessageMonitoringTransaction extends TonSdkStructure {
  ...
  MessageMonitoringTransaction({
    ...
    MessageMonitoringTransactionCompute? compute,
  }) {
    _hash = hash;
    _aborted = ArgumentError.checkNotNull(
        aborted, 'MessageMonitoringTransaction aborted');
    _compute = compute;
  }
  MessageMonitoringTransaction.fromMap(Map<String, dynamic> map) {
    ...
    if (map.containsKey('compute') && (map['compute'] != null)) {
      _compute = MessageMonitoringTransactionCompute.fromMap(map['compute']);
    }
  }
...
class MessageMonitoringParams extends TonSdkStructure {
  ...
  MessageMonitoringParams({
    ...
    required int wait_until,
    dynamic? user_data,
  }) {
    _message =
        ArgumentError.checkNotNull(message, 'MessageMonitoringParams message');
    _wait_until = ArgumentError.checkNotNull(
        wait_until, 'MessageMonitoringParams wait_until');
    _user_data = user_data;
  }
  MessageMonitoringParams.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('message') && (map['message'] != null)) {
      _message = MonitoredMessage.fromMap(map['message']);
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('wait_until') && (map['wait_until'] != null)) {
      _wait_until = map['wait_until'];
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('user_data') && (map['user_data'] != null)) {
      _user_data = map['user_data'];
    }
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    if (_wait_until != null) {
      map['wait_until'] = _wait_until;
    }
    if (_user_data != null) {
      map['user_data'] = _user_data;
    }
    return map;
  }
}
...
class MessageMonitoringResult extends TonSdkStructure {
  ...
  MessageMonitoringResult({
    ...
    required MessageMonitoringStatus status,
    MessageMonitoringTransaction? transaction,
    String? error,
    dynamic? user_data,
  }) {
    _hash = ArgumentError.checkNotNull(hash, 'MessageMonitoringResult hash');
    _status =
        ArgumentError.checkNotNull(status, 'MessageMonitoringResult status');
    _transaction = transaction;
    _error = error;
    _user_data = user_data;
  }
  MessageMonitoringResult.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('hash') && (map['hash'] != null)) {
      _hash = map['hash'];
    } else {
      throw ('Wrong map data');
    ...
    if (map.containsKey('status') && (map['status'] != null)) {
      _status = MessageMonitoringStatus.fromMap(map['status']);
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('transaction') && (map['transaction'] != null)) {
      _transaction = MessageMonitoringTransaction.fromMap(map['transaction']);
    }
    if (map.containsKey('error') && (map['error'] != null)) {
      _error = map['error'];
    }
...
class MonitorFetchWaitMode {
  ...
  MonitorFetchWaitMode.fromMap(str) {
    _value = str;
  }
}
...
class MonitoredMessage_Boc extends MonitoredMessage {
  ...
  MonitoredMessage_Boc.fromMap(Map<String, dynamic> map) {
    if (!map.containsKey('type') || map['type'] != 'Boc') {
      throw ('Wrong map data');
    } else {
      _type = 'Boc';
    }
...
class MonitoredMessage_HashAddress extends MonitoredMessage {
  ...
  MonitoredMessage_HashAddress({
    ...
    _type = 'HashAddress';
    _hash =
        ArgumentError.checkNotNull(hash, 'MonitoredMessage_HashAddress hash');
    _address = ArgumentError.checkNotNull(
        address, 'MonitoredMessage_HashAddress address');
  }
  MonitoredMessage_HashAddress.fromMap(Map<String, dynamic> map) {
    if (!map.containsKey('type') || map['type'] != 'HashAddress') {
      throw ('Wrong map data');
    } else {
      _type = 'HashAddress';
    }
...
class MessageMonitoringStatus {
  ...
  MessageMonitoringStatus.fromMap(str) {
    _value = str;
  }
}
...
class MessageSendingParams extends TonSdkStructure {
  ...
  MessageSendingParams({
    ...
    _wait_until = ArgumentError.checkNotNull(
        wait_until, 'MessageSendingParams wait_until');
    _user_data = user_data;
  }
  MessageSendingParams.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('boc') && (map['boc'] != null)) {
      _boc = map['boc'];
    } else {
      throw ('Wrong map data');
...
class ParamsOfMonitorMessages extends TonSdkStructure {
  ...
  ParamsOfMonitorMessages({
    ...
    _messages = ArgumentError.checkNotNull(
        messages, 'ParamsOfMonitorMessages messages');
  }
  ParamsOfMonitorMessages.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('queue') && (map['queue'] != null)) {
      _queue = map['queue'];
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('messages') && (map['messages'] != null)) {
      ...
      for (var el in map['messages']) {
        if (el != null) {
          _messages?.add(MessageMonitoringParams.fromMap(el));
        } else {}
      }
    } else {
      throw ('Wrong map data');
...
class ParamsOfGetMonitorInfo extends TonSdkStructure {
  ...
  ParamsOfGetMonitorInfo.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('queue') && (map['queue'] != null)) {
      _queue = map['queue'];
    } else {
      throw ('Wrong map data');
...
class MonitoringQueueInfo extends TonSdkStructure {
  ...
  MonitoringQueueInfo({
    ...
    _unresolved = ArgumentError.checkNotNull(
        unresolved, 'MonitoringQueueInfo unresolved');
    _resolved =
        ArgumentError.checkNotNull(resolved, 'MonitoringQueueInfo resolved');
  }
  MonitoringQueueInfo.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('unresolved') && (map['unresolved'] != null)) {
      _unresolved = map['unresolved'];
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('resolved') && (map['resolved'] != null)) {
      _resolved = map['resolved'];
    } else {
      throw ('Wrong map data');
    }
  }
...
class ParamsOfFetchNextMonitorResults extends TonSdkStructure {
  ...
  ParamsOfFetchNextMonitorResults({
    required String queue,
    MonitorFetchWaitMode? wait_mode,
  }) {
    _queue = ArgumentError.checkNotNull(
        queue, 'ParamsOfFetchNextMonitorResults queue');
    _wait_mode = wait_mode;
  }
  ParamsOfFetchNextMonitorResults.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('queue') && (map['queue'] != null)) {
      _queue = map['queue'];
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('wait_mode') && (map['wait_mode'] != null)) {
      _wait_mode = MonitorFetchWaitMode.fromMap(map['wait_mode']);
    }
  }
...
class ResultOfFetchNextMonitorResults extends TonSdkStructure {
  ...
  ResultOfFetchNextMonitorResults({
    ...
    _results = ArgumentError.checkNotNull(
        results, 'ResultOfFetchNextMonitorResults results');
  }
  ResultOfFetchNextMonitorResults.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('results') && (map['results'] != null)) {
      _results = [];
      for (var el in map['results']) {
        if (el != null) {
          _results?.add(MessageMonitoringResult.fromMap(el));
        } else {}
      }
    } else {
      throw ('Wrong map data');
...
class ParamsOfCancelMonitor extends TonSdkStructure {
  ...
  ParamsOfCancelMonitor.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('queue') && (map['queue'] != null)) {
      _queue = map['queue'];
    } else {
      throw ('Wrong map data');
...
class ParamsOfSendMessages extends TonSdkStructure {
  ...
  ParamsOfSendMessages({
    ...
    String? monitor_queue,
  }) {
    _messages =
        ArgumentError.checkNotNull(messages, 'ParamsOfSendMessages messages');
    _monitor_queue = monitor_queue;
  }
  ParamsOfSendMessages.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('messages') && (map['messages'] != null)) {
      _messages = [];
      for (var el in map['messages']) {
        if (el != null) {
          _messages?.add(MessageSendingParams.fromMap(el));
        } else {}
      }
    } else {
      throw ('Wrong map data');
    }
    if (map.containsKey('monitor_queue') && (map['monitor_queue'] != null)) {
      _monitor_queue = map['monitor_queue'];
    }
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    if (_monitor_queue != null) {
      map['monitor_queue'] = _monitor_queue;
    }
    return map;
  }
}
...
class ResultOfSendMessages extends TonSdkStructure {
  ...
  ResultOfSendMessages({
    ...
    _messages =
        ArgumentError.checkNotNull(messages, 'ResultOfSendMessages messages');
  }
  ResultOfSendMessages.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('messages') && (map['messages'] != null)) {
      _messages = [];
      for (var el in map['messages']) {
        if (el != null) {
