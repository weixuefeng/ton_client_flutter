...
class Tvc_V1 extends Tvc {
  ...
  Tvc_V1.fromMap(Map<String, dynamic> map) {
    if (!map.containsKey('type') || map['type'] != 'V1') {
      throw ('Wrong map data');
    } else {
      _type = 'V1';
    }
    if (map.containsKey('value') && (map['value'] != null)) {
      _value = TvcV1.fromMap(map['value']);
    } else {
      throw ('Wrong map data');
    }
  }
...
class TvcV1 extends TonSdkStructure {
  ...
  TvcV1.fromMap(Map<String, dynamic> map) {
...
class ParamsOfDecodeStateInit extends TonSdkStructure {
  ...
  ParamsOfDecodeStateInit({
    ...
    _state_init = ArgumentError.checkNotNull(
        state_init, 'ParamsOfDecodeStateInit state_init');
    _boc_cache = boc_cache;
  }
  ParamsOfDecodeStateInit.fromMap(Map<String, dynamic> map) {
...
class ResultOfDecodeStateInit extends TonSdkStructure {
  ...
  ResultOfDecodeStateInit.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('code') && (map['code'] != null)) {
      _code = map['code'];
    }
...
class ParamsOfEncodeStateInit extends TonSdkStructure {
  ...
  ParamsOfEncodeStateInit.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('code') && (map['code'] != null)) {
      _code = map['code'];
    }
    if (map.containsKey('data') && (map['data'] != null)) {
...
class ResultOfEncodeStateInit extends TonSdkStructure {
  ...
  ResultOfEncodeStateInit({
    ...
    _state_init = ArgumentError.checkNotNull(
        state_init, 'ResultOfEncodeStateInit state_init');
  }
  ResultOfEncodeStateInit.fromMap(Map<String, dynamic> map) {
    if (map.containsKey('state_init') && (map['state_init'] != null)) {
      _state_init = map['state_init'];
    } else {
      throw ('Wrong map data');
