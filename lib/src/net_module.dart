...
class NetModule extends _TonSdkModule {
  ...
  Future<ResultOfQuery> query(ParamsOfQuery params) async {
    final res = await _tonCore.request('net.query', params.toString(), null);
  ...
  Future<ResultOfBatchQuery> batch_query(ParamsOfBatchQuery params) async {
    final res =
        await _tonCore.request('net.batch_query', params.toString(), null);
  ...
  Future<ResultOfQueryCollection> query_collection(
    ...
    final res =
        await _tonCore.request('net.query_collection', params.toString(), null);
  ...
  Future<ResultOfAggregateCollection> aggregate_collection(
    ...
    final res = await _tonCore.request(
        'net.aggregate_collection', params.toString(), null);
  ...
  Future<ResultOfSubscribeCollection> subscribe_collection(
      ParamsOfSubscribeCollection params, Function? responseHandler) async {
    final res = await _tonCore.request(
  ...
  ///(for example transactions of the specific account): application must
  ///refresh all cached (or visible to user) lists where this sequences presents.
  Future<ResultOfSubscribeCollection> subscribe(
      ParamsOfSubscribe params, Function? responseHandler) async {
    final res = await _tonCore.request(
  ...
  Future<void> suspend() async {
    await _tonCore.request('net.suspend', null, null);
  }

  ///Resumes network module to enable network activity
  Future<void> resume() async {
    await _tonCore.request('net.resume', null, null);
  }
  ...
  Future<ResultOfQueryCollection> query_counterparties(
    ...
    final res = await _tonCore.request(
        'net.query_counterparties', params.toString(), null);
    return ResultOfQueryCollection.fromMap(res);
  }
  ...
  Future<ResultOfQueryTransactionTree> query_transaction_tree(
    ...
    final res = await _tonCore.request(
        'net.query_transaction_tree', params.toString(), null);
  ...
  Future<RegisteredIterator> create_block_iterator(
    ...
    final res = await _tonCore.request(
        'net.create_block_iterator', params.toString(), null);
  ...
  Future<RegisteredIterator> resume_block_iterator(
    ...
    final res = await _tonCore.request(
        'net.resume_block_iterator', params.toString(), null);
    return RegisteredIterator.fromMap(res);
  }
  ...
  Future<RegisteredIterator> create_transaction_iterator(
    ...
    final res = await _tonCore.request(
        'net.create_transaction_iterator', params.toString(), null);
    return RegisteredIterator.fromMap(res);
  }
  ...
  Future<RegisteredIterator> resume_transaction_iterator(
    ...
    final res = await _tonCore.request(
        'net.resume_transaction_iterator', params.toString(), null);
    return RegisteredIterator.fromMap(res);
  }
  ...
  Future<ResultOfIteratorNext> iterator_next(
    ...
    final res =
        await _tonCore.request('net.iterator_next', params.toString(), null);
  ...
  Future<void> remove_iterator(RegisteredIterator params) async {
    await _tonCore.request('net.remove_iterator', params.toString(), null);
  }
  ...
  Future<ResultOfGetSignatureId> get_signature_id() async {
    final res = await _tonCore.request('net.get_signature_id', null, null);
